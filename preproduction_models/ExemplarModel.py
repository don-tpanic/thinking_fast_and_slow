...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar  7 14:25:03 2023

Exemplar model
- basic: no attention, just recruit nodes and connection weights
- dimension-wise attention (alcove-like)
...
class ExemplarModel(nn.Module):
    def __init__(self, model_info, params=False, fitparams=False,
                 start_params=None):
        super(ExemplarModel, self).__init__()
...
def train_exemplar(model, inputs, output, n_epochs, shuffle=False):
